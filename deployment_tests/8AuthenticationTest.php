...
class AuthenticationTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $user = new \app\Helpers\User('temp_user_delete_me','Basic_Password',$this->company,true);
    ...
    {
        global $user;
        $user = new \app\Helpers\User('temp_user_delete_me','Basic_Password',$this->company,false);
        $this->addToAssertionCount(1);
    }
    ...
    function test_Delete_Temp_User()
    {
        ...
        $this->expectException(\app\Helpers\User_Does_Not_Exist::class);
        $user = new \app\Helpers\User('temp_user','Basic_Password',$this->company,false);
