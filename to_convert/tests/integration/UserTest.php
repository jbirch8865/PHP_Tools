...
class UserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function I_Have_Not_Tried_To_Login_This_Session_Yet()
    {
        $user = new \User_Session\Current_User;
        $this->assertFalse(invokeMethod($user, 'Does_User_Session_Exist'));
    }

    public function I_Have_Tried_And_Failed_To_Login_This_Session()
    {
    }
    ...
    public function test_Get_New_Salt()
    {
        $user = new \User_Session\User_Session;
    ...
    public function test_Does_User_Exist()
    {
        $this->user = new \User_Session\User_Session;
        $this->user->Set_Username($this->username);
    ...
    public function test_Authenticate_User_With_Correct_Password()
    {
        $this->user = new \User_Session\User_Session;
        $this->user->Set_Username($this->username);
        $this->user->Set_Password('TestAPassword');
    ...
    public function test_Authenticate_User_With_Incorrect_Password()
    {
    ...
    public function test_Current_Session_And_Is_Authenticated()
    {
        $user = new \User_Session\Current_User;
    ...
    public function test_Current_Session_Is_Not_Authenticated()
    {
        $user = new \User_Session\Current_User;
