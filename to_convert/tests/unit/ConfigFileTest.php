...
class ConfigFileTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_Errors_On_Non_String()
    {
    ...
    public function test_Return_Empty_Array_On_Non_Existent_File()
    {
        $this->configs = new config\ConfigurationFile("NotAValidFile.ini.test");
        $this->assertIsArray($this->configs->Configurations());
    }

    public function test_Return_Empty_Array_On_Default_File()
    {
        $this->configs = new config\ConfigurationFile();
        $this->assertIsArray($this->configs->Configurations());
    }

    public function test_Return_Known_Configs_From_File()
    {
    ...
    public function test_Expect_Exception_On_Non_Ini_File()
    {
        $this->expectException(Exception::class);
