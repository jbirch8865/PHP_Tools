...
//ADODB_Active_Record::TableKeyHasMany('Companies','id','Users','company_id','\app\Helpers\Company');
//ADODB_Active_Record::TableBelongsTo('Users','Companies','company_id','id','\app\Helpers\Company');
