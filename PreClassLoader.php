...
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'AddressClass.php';
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'PhoneNumberClass.php';
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'TwilioClass.php';
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'TagClass.php';
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'ObjectTagsClass.php';
require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'TagsHaveRolesClass.php';
